...
| 폴더 | 현재본 | 격리한 것 |
|---|---|---|
| `06_졸업논문` | `권혁찬_졸업논문_최종본.docx` · `.pdf` (v5.0) | — 새로 만든 폴더 |
| `03_최종산출물` | 연구 데이터·재현 코드(계보 자료) | `01_논문/`, `01_논문_최종본/`, 승인 워크플로 HTML 3개, 낡은 안내 |
| `04_발표자료` | 없음 (v5.0 덱 미작성) | 260720 덱 2개 + `발표원고_v4.0.md` |
| 루트 | `00_먼저_읽기.md` (새로 씀) | 옛 `00_먼저_읽기.md` |

`01_논문_최종본/권혁찬_졸업논문_최종본.docx`(2026-07-27)는 표지에 **"v4.0 최종 보고"**라고
적혀 있고 "규칙 16개 전부에 문헌 근거를 연결했다"고 쓴다. v5.0에서는 9개·링크 10건이다.
이름이 `최종본`이라 가장 위험했다.

**아직 남은 것**: 권혁찬에게는 여형준 `09`에 해당하는 v5.0 기준 연구 완료 발표자료가 없다.
