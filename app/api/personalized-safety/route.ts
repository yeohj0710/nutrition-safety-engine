...
const actionPlans: Record<string, string> = {
  A1: "그래서 지금은 제품 라벨의 비타민 K 함량, 최근 식사 변화, INR 변화를 같은 날짜 기준으로 정리해 두면 됩니다. 섭취량을 갑자기 바꾸지 않는 것이 중요합니다.",
  A2: "그래서 지금은 제품 라벨에서 EPA와 DHA의 하루 합산량을 계산하고, 코피·멍·잇몸출혈이 있었는지만 함께 기록하면 됩니다. 현재 연구만으로 2,000 mg/day의 개인별 안전 여부를 단정할 수는 없습니다.",
  B1: "그래서 지금은 제품 라벨의 원소 칼슘과 음식으로 먹는 칼슘을 나누어 계산하면 됩니다. 결석 성분과 24시간 요중 칼슘을 함께 봐야 하므로 600 mg/day라는 숫자만으로 많고 적음을 정할 수는 없습니다.",
  B2: "그래서 지금은 모든 제품의 비타민 D 총량과 복용 기간을 합산하고, 25(OH)D·혈청 칼슘·24시간 요중 칼슘의 변화를 같은 시점끼리 비교하면 됩니다.",
  B3: "그래서 지금은 여러 제품에 든 비타민 C의 하루 총량과 복용 기간을 합산하고, 결석 성분·신장기능·요중 옥살산의 변화를 함께 보면 됩니다.",
};
