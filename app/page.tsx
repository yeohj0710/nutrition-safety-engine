...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(213,230,214,0.7),_transparent_35%),linear-gradient(180deg,_#f7f4ee_0%,_#f2efe7_100%)] px-4 py-8 md:px-8">
      <div className="mx-auto mb-6 flex max-w-7xl items-center justify-between rounded-full border border-stone-200 bg-white/70 px-5 py-3 backdrop-blur">
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-stone-500">Nutrition Safety Engine</p>
          <p className="text-sm text-stone-700">결정적 규칙/근거 탐색기</p>
        </div>
