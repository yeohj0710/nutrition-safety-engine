...
python -m tools.search_pipeline.cli classify --profile anticoag_renal --date-tag 20260603
python -m tools.search_pipeline.cli seed-rules --profile anticoag_renal --date-tag 20260603
```
