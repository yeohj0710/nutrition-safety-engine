...
`build_extended_evidence_v41.py` 가 만든 합본은 40MB 다. 라우트가 그것을 통째로
...
git 에서 뺐다(.gitignore). `build_extended_evidence_v41.py` 를 다시 돌린 뒤에는
이 스크립트도 같이 돌려야 한다.
...
SRC = os.path.join(
    ROOT, "research", "systematic_review_v41", "extended_evidence_v41.json"
)
OUT_DIR = os.path.join(
    ROOT, "research", "systematic_review_v41", "extended_evidence_v41"
)
