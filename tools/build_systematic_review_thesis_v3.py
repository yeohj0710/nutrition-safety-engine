...
m=json.loads((D/"manifest.json").read_text(encoding="utf-8"));cm=json.loads((D/"core_manifest.json").read_text(encoding="utf-8"));core=pd.read_csv(D/"core_evidence.csv").fillna("");quality=json.loads((R/"research/validation/software_quality_v3.json").read_text(encoding="utf-8"));links=json.loads((R/"research/validation/evidence_link_check_v3.json").read_text(encoding="utf-8"))
