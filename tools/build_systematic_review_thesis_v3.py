...
m=json.loads((D/"manifest.json").read_text(encoding="utf-8"));cm=json.loads((D/"core_manifest.json").read_text(encoding="utf-8"));core=pd.read_csv(D/"core_evidence.csv").fillna("")
...
doc.add_heading("3.4 소프트웨어와 배포 검증",2);table(doc,["검증 항목","결과"],[["자동 테스트","59개 통과"],["lint","통과"],["TypeScript","통과"],["Production build","통과"],["배포 환경","Vercel Production"],["고정 URL","https://nutrition-safety-engine.vercel.app"]])
