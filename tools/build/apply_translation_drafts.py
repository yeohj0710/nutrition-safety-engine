...
`translation_drafts.py` 의 75줄을 읽어 질문별 파트 파일 다섯 개로 쓴다.
...
유료 호출 없음. 같은 입력에 같은 출력이다.
    ...
    python -m tools.build.apply_translation_drafts
"""
...
from tools.build.translation_drafts import DRAFTS

ROOT = Path(__file__).resolve().parents[2]
CORE = ROOT / "research" / "systematic_review" / "core_evidence.csv"
PARTS = ROOT / "research" / "systematic_review" / "etc" / "translation_parts"
AUTHOR = "Claude"
