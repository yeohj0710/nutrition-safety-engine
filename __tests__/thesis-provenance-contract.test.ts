...
function fixture() {
  ...
  return {
    ...
    reports: [{ report_id: "RPT-1", question_id: "A1", verification_status: "validated" }],
    extractions: [{ extraction_id: "EXT-1", report_id: "RPT-1", question_id: "A1", verification_status: "validated" }],
    claims: [{
