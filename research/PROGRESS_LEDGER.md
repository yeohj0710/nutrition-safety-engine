...
| 04 screening and full text | blocked_external_proxy_verified | exact retrieval→2 proxies→human-queue lineage for 19,961+207+62 units; 6/6 mutations rejected; PMC sentinel 1 OA XML/19 paragraph hashes + 2 non-OA rows; human decisions 0; AI-only exclusions 0 | human title/abstract/registry/full-text review, non-OA requests after advancement, adjudication, final reports/studies/PRISMA |
