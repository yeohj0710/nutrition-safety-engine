...
| 07 engine validation and release | blocked_external_safe_empty_verified | deterministic matcher; 48 tests; local production smoke 11/11; SHA-bound 120×3 proxy; legacy leakage 0; human queue preservation 3/3 and progress states 6/6; validated deployment false | validated rules, independent authored/adjudicated gold, expert review, release manifest and verified deployment |
