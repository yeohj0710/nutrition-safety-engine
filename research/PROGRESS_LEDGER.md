...
| 04 screening and full text | blocked_external_proxy_verified | exact retrieval→human queue lineage; blinded secondary builder 5/5; PMC sentinel 1 OA XML/19 paragraph hashes + 2 non-OA rows; human decisions 0; AI-only exclusions 0 | human primary/secondary/registry/full-text review, non-OA requests, adjudication, final reports/studies/PRISMA |
