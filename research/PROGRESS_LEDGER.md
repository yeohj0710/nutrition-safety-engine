...
| 07 engine validation and release | blocked_external_safe_empty_verified | deterministic matcher; 51 tests; local production smoke 11/11; SHA-bound 120×3 proxy; legacy leakage 0; queue preservation 3/3, progress 6/6; fail-closed independent evaluator, gold 0 and metrics null; validated deployment false | validated rules, 120 independent authored/adjudicated gold, expert review, release manifest and verified deployment |
