...
| 05 extraction quality and AI | blocked_external_proxy_verified | exact 55-field extraction schema; verified fulltext→extraction/RoB routing 6/6; report→PMCID→paragraph contract; fail-closed production AI evaluator with raw input/prompt/output SHA lineage, contracts 5/5, empty metrics null; human/RoB/gold/AI/review 0/0/0/0/0 | included reports, human-verified locators/extraction/RoB/gold, actual AI runs and field review |
