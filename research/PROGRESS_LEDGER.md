...
| 06 synthesis claims and rules | blocked_external_safe_empty | five no-analysis decisions; 11/11 schema/semantic contracts plus 9-test provenance suite; source bytes/root boundary→extraction→GRADE→claim→rule gate; certainty/claim/rule registries 0; legacy promotion 0 | accepted extraction/RoB, human synthesis/GRADE, expert and independent-scenario validation |
