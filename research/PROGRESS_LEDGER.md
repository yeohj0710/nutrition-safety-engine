...
| 05 extraction quality and AI | blocked_external_proxy_verified | verified fulltext→extraction/RoB routing 6/6; report→record→PMCID→paragraph contract; 10 boundary mutations; human/RoB/AI 0/0/0 | included reports, human-verified locators/extraction/RoB/gold, actual AI runs |
