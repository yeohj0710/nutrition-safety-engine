...
갱신 시각: 2026-07-27 08:04 KST

- 현재 단계: P2 진행 중 — 신규 v3.0 코퍼스 1,000/2,209행 로컬 AI 선별 완료
...
- 현재 선별: canonical 체크포인트 1,000행; 커버리지 0.4526935265; 배치 감사 로그 10개; 분포 `deprioritize=691`, `retain=195`, `uncertain=114`; 체크포인트 SHA-256 `f3f7cb653ddc2ef404541c76c9fc76ca9d9c156f7105f265763147452a8b98ec`
...
- 미해결 문제: 남은 1,209행을 100행 단위로 이어서 판정하고, 커버리지 1.0 검증 뒤 CSV·매니페스트를 확정해야 한다.
