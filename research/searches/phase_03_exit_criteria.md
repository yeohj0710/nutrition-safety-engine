...
| Registry screening/linkage | 207 undecided rows; 500 registry→PubMed candidate links; paired review context includes 46 RESULT, 127 DERIVED, 327 BACKGROUND citations; canonical 500-row human decision queue with allowed decisions, study/report IDs, reason, verifier/time, progress states, and byte-preservation 2/2; 0 human decisions | blocked_external |
