...
| Registry/KoreaMed review context | pass_proxy_only | 207/207 registry rows include title, status, design, enrollment, condition, intervention, sponsor, dates, results flag, URL, and query-risk warning; 62/62 KoreaMed rows include title, URL, export limitation, and 35 exact-title PubMed candidates with XML paths; decision authority none |
